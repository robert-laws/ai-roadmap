...
export const tracks: Track[] = [
  makeTrack(
    ...
    "1-2 weeks",
    "#ff5c45",
    "linear-gradient(135deg, #261b2e 0%, #ff5c45 52%, #ffd166 100%)",
    Bot,
    [],
  ...
  makeTrack(
    ...
    "Parallel after A",
    "#00a6d6",
    "linear-gradient(135deg, #082f49 0%, #00a6d6 55%, #b8f7ff 100%)",
    Images,
    [],
  ...
  makeTrack(
    ...
    "#8bd346",
    "linear-gradient(135deg, #18371d 0%, #8bd346 52%, #f4ffc4 100%)",
    Code2,
    [],
  ...
  makeTrack(
    ...
    "After C basics",
    "#a36bff",
    "linear-gradient(135deg, #251a40 0%, #a36bff 54%, #ddd1ff 100%)",
    Gamepad2,
    ["C", "B"],
  ...
  makeTrack(
    ...
    "After B + C",
    "#ffb000",
    "linear-gradient(135deg, #402600 0%, #ffb000 50%, #fff0b8 100%)",
    Layers3,
    ["B", "C"],
  ...
  makeTrack(
    ...
    "Ongoing after A",
    "#00c28b",
    "linear-gradient(135deg, #053b34 0%, #00c28b 54%, #c6ffe8 100%)",
    CalendarClock,
    ["A"],
